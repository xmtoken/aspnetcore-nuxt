    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManyEntity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ManyEntity_CustomerEntity_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OneEntity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OneEntity_CustomerEntity_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "CustomerEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManyEntity_CustomerId",
                table: "ManyEntity",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_OneEntity_CustomerId",
                table: "OneEntity",
                column: "CustomerId",
                unique: true);
