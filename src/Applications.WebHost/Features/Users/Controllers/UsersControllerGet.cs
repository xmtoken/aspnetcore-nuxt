...
namespace AspNetCoreNuxt.Applications.WebHost.Features.Users.Controllers
{
    public partial class UsersController
    {
        ...
        [Authorize]
        [HttpGet]
        public Task<IPagination<User>> Get([FromQuery] UserSearchConditions conditions, [FromQuery(Name = "sort")] IEnumerable<Sorting> sort, [FromQuery] Paging paging, [FromQuery] IEnumerable<string> fields)
        {
