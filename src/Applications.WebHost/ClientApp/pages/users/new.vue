  ...
  <app-dialog max-width="420" right scrollable :value="true" @input="onDialogClose">
    <validation-observer ref="observer" slim>
      <v-form autocomplete="off" @submit.prevent>
        ...
        <v-card>
          <v-card-text>
            <app-username-field v-model="entity.userName" label="ユーザー名" :maxlength="$metadata.user.name.maxLength" vee-rules="required|username" vee-vid="UserName" />
            ...
            <app-text-field v-model="entity.emailAddress" label="メールアドレス" :maxlength="$metadata.userProfile.emailAddress.maxLength" vee-rules="required|email" vee-vid="EmailAddress" />
            ...
            <app-select v-model="entity.gender" :items="$enum.gender" label="性別" vee-rules="required" vee-vid="Gender" />
