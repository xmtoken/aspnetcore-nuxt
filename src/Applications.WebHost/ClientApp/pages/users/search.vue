<script>
import { AppDateField, AppDialog, AppSelect, AppTextField } from '~/components';
export default {
  components: {
    AppDateField,
    AppDialog,
  ...
  data() {
    return {
      conditions: {
        ...
        gender: Array.create(this.$route.query.gender).ofIntegers(),
        role: Array.create(this.$route.query.role).ofIntegers(),
      },
      items: {
        roles: [],
      },
