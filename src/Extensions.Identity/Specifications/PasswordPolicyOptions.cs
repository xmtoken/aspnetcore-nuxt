namespace AspNetCoreNuxt.Extensions.Identity.Specifications
{
    ...
    public class PasswordPolicyOptions
    {
        ...
        /// <summary>
        /// <see cref="PasswordPolicyOptions"/> クラスの新しいインスタンスを作成します。
        /// </summary>
        ...
        public PasswordPolicyOptions(int requireLength, bool requireDigit, bool requireLowercase, bool requireUppercase)
        {
